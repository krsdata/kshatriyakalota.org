<?php
    ...
    */
        ...
        <div id="poststuff">
            ...
            <div id="post-body" class="metabox-holder columns-2">  
                ...
                <div id="postbox-container-1" class="postbox-container"> 
                    <div class="postbox"> 
                        <h3 class="hndle"><span></span>Best WP Themes</h3> 
                        <div class="inside">
                            <center><a target="_blank" href="https://mythemeshop.com/?ref=nik_gandhi007"><img src="<?php echo plugins_url( 'images/300x250.png', __FILE__ );?>" alt="" border="0"></a></center>
                ...
                <div id="post-body" class="metabox-holder columns-2">
                    ...
                    <div id="postbox-container-1" class="postbox-container"> 
                        ...
                        <div class="postbox"> 
                            <h3 class="hndle"><span></span>Best WP Themes </h3> 
                            <div class="inside">
                                <center><a href="https://mythemeshop.com/?ref=nik_gandhi007" target="_blank"><img src="<?php echo plugins_url( 'images/300x250.png', __FILE__ );?>" width="250" height="250" border="1" ALT="Click to Visit"></a></center>
    ...
    function print_verticalScroll_func($atts){
        ...
        ob_start();
    ?>
        <marquee height='<?php echo $height; ?>'  onmouseout="this.start()" onmouseover="this.stop()" scrolldelay="<?php echo $delay; ?>" scrollamount="<?php echo $scrollamount; ?>" direction="up" behavior="scroll" >
